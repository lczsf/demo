...
<head>
    ...
    <link rel="shortcut icon" href="http://www.getuikit.net/docs/images/favicon.ico" type="image/x-icon">
    <link rel="apple-touch-icon-precomposed" href="http://www.getuikit.net/docs/images/apple-touch-icon.png">
    <link rel="stylesheet" href="../../web/uikit/css/uikit.css">
    <script src="../../web/js/jquery.js"></script>
    <script src="../../web/uikit/js/uikit.js"></script>
</head>
...
<div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">
    ...
    <nav class="uk-navbar uk-margin-large-bottom">
        <a class="uk-navbar-brand uk-hidden-small" href="http://www.getuikit.net/docs/layouts_frontpage.html">Brand</a>
        <ul class="uk-navbar-nav uk-hidden-small">
            <li class="uk-active">
                <a href="http://www.getuikit.net/docs/layouts_frontpage.html">Navigation1</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_portfolio.html">Navigation2</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_blog.html">Navigation3</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_documentation.html">Navigation4</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_contact.html">Navigation5</a>
            </li>
            <li>
                <a href="http://demo.com:8089/web/auth/login">Login</a>
                <%--<a href="http://www.getuikit.net/docs/layouts_login.html">Login</a>--%>
            </li>
        </ul>
        ...
        <div class="uk-width-medium-1-1 uk-row-first">
            ...
            <div class="uk-vertical-align uk-text-center"
                ...
                <div class="uk-vertical-align-middle uk-width-1-2">
                    ...
                    <p class="uk-text-large">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Fusce dapibus,
    ...
    <div class="uk-grid" data-uk-grid-margin="">
        <div class="uk-width-medium-1-1 uk-row-first">
            <div class="uk-panel uk-panel-box uk-text-center">
                <p><strong>Phasellus viverra nulla ut metus.</strong> Quisque rutrum etiam ultricies nisi vel augue. <a
                        class="uk-button uk-button-primary uk-margin-left" href="#">Button</a></p>
            </div>
        </div>
    </div>
...
<div id="offcanvas" class="uk-offcanvas">
    <div class="uk-offcanvas-bar">
        <ul class="uk-nav uk-nav-offcanvas">
            <li class="uk-active">
                <a href="http://www.getuikit.net/docs/layouts_frontpage.html">Frontpage</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_portfolio.html">Portfolio</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_blog.html">Blog</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_documentation.html">Documentation</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_contact.html">Contact</a>
            </li>
            <li>
                <a href="http://www.getuikit.net/docs/layouts_login.html">Login</a>
            </li>
